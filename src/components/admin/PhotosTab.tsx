...
const PHOTO_GROUPS: PhotoGroup[] = [
  ...
  },
  {
    label: "Sections",
    photos: [
      { path: "/images/sections/urgence-card.png", filename: "sections/urgence-card.png", usage: "Section depannage urgent + realisation depannage-grenoble (avant)" },
  ...
  },
  {
    ...
    photos: [
      ...
      { path: "/images/pages/renovation-douche-italienne.jpeg", filename: "pages/renovation-douche-italienne.jpeg", usage: "Page douche italienne + realisation douche-seyssins" },
      { path: "/images/pages/renovation-pmr.jpeg", filename: "pages/renovation-pmr.jpeg", usage: "Page salle de bain PMR + realisation sdb-pmr-fontaine" },
      { path: "/images/pages/chauffage-chaudiere-gaz.jpeg", filename: "pages/chauffage-chaudiere-gaz.jpeg", usage: "Page chaudiere gaz + realisation chaudiere-saint-egreve" },
      { path: "/images/pages/chauffage-pac.jpeg", filename: "pages/chauffage-pac.jpeg", usage: "Page pompe a chaleur" },
      { path: "/images/pages/chauffage-plancher-chauffant.jpeg", filename: "pages/chauffage-plancher-chauffant.jpeg", usage: "Page plancher chauffant + realisation plancher-claix" },
    ],
  },
  {
    label: "Realisations — Avant",
    photos: [
      { path: "/images/realisations/sdb-seyssinet-before.jpeg", filename: "realisations/sdb-seyssinet-before.jpeg", usage: "Salle de bain Seyssinet-Pariset — avant travaux" },
      { path: "/images/realisations/cuisine-grenoble-before.png", filename: "realisations/cuisine-grenoble-before.png", usage: "Cuisine Grenoble — avant travaux" },
      { path: "/images/realisations/chauffe-eau-echirolles-before.png", filename: "realisations/chauffe-eau-echirolles-before.png", usage: "Chauffe-eau Echirolles — avant travaux" },
      { path: "/images/realisations/pac-meylan-before.jpeg", filename: "realisations/pac-meylan-before.jpeg", usage: "PAC Meylan — avant travaux" },
      { path: "/images/realisations/sdb-pmr-fontaine-before.jpeg", filename: "realisations/sdb-pmr-fontaine-before.jpeg", usage: "SDB PMR Fontaine — avant travaux" },
      { path: "/images/realisations/chaudiere-saint-egreve-before.png", filename: "realisations/chaudiere-saint-egreve-before.png", usage: "Chaudiere Saint-Egreve — avant travaux" },
      { path: "/images/realisations/douche-seyssins-before.png", filename: "realisations/douche-seyssins-before.png", usage: "Douche Seyssins — avant travaux" },
      { path: "/images/realisations/plancher-chauffant-claix-before.png", filename: "realisations/plancher-chauffant-claix-before.png", usage: "Plancher chauffant Claix — avant travaux" },
      { path: "/images/realisations/sdb-complete-vizille-before.png", filename: "realisations/sdb-complete-vizille-before.png", usage: "SDB complete Vizille — avant travaux" },
    ],
  },
  {
    label: "Realisations — Apres",
    photos: [
      { path: "/images/realisations/sdb-seyssinet-after.png", filename: "realisations/sdb-seyssinet-after.png", usage: "Salle de bain Seyssinet-Pariset — apres travaux" },
      { path: "/images/realisations/cuisine-grenoble-after.jpeg", filename: "realisations/cuisine-grenoble-after.jpeg", usage: "Cuisine Grenoble — apres travaux" },
      { path: "/images/realisations/chauffe-eau-echirolles-after.png", filename: "realisations/chauffe-eau-echirolles-after.png", usage: "Chauffe-eau Echirolles — apres travaux" },
      { path: "/images/realisations/pac-meylan-after.png", filename: "realisations/pac-meylan-after.png", usage: "PAC Meylan — apres travaux" },
      { path: "/images/realisations/depannage-grenoble-after.png", filename: "realisations/depannage-grenoble-after.png", usage: "Depannage Grenoble — apres travaux" },
    ],
  },
];
